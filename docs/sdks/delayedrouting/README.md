...
<!-- UsageSnippet language="typescript" operationID="payment-create-route" method="post" path="/v2/payments/{paymentId}/routes" example="create-route-201-1" -->
```typescript
...
<!-- UsageSnippet language="typescript" operationID="payment-list-routes" method="get" path="/v2/payments/{paymentId}/routes" example="list-routes-200-1" -->
```typescript
import { Client } from "mollie-api-typescript";
...
<!-- UsageSnippet language="typescript" operationID="payment-get-route" method="get" path="/v2/payments/{paymentId}/routes/{routeId}" example="get-route-200-1" -->
```typescript
import { Client } from "mollie-api-typescript";
...
async function run() {
  const result = await client.delayedRouting.get({
    paymentId: "tr_5B8cwPMGnU",
...
```typescript
import { ClientCore } from "mollie-api-typescript/core.js";
import { delayedRoutingGet } from "mollie-api-typescript/funcs/delayedRoutingGet.js";
...
async function run() {
  const res = await delayedRoutingGet(client, {
    paymentId: "tr_5B8cwPMGnU",
    routeId: "crt_dyARQ3JzCgtPDhU2Pbq3J",
    idempotencyKey: "123e4567-e89b-12d3-a456-426",
  });
  if (res.ok) {
    ...
    console.log("delayedRoutingGet failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PaymentGetRouteRequest](../../models/operations/paymentgetrouterequest.md)                                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.RouteGetResponse](../../models/routegetresponse.md)\>**
