...
```typescript
import { ListEntityUnmatchedCreditTransfer } from "mollie-api-typescript/models";

let value: ListEntityUnmatchedCreditTransfer = {
...
| `source`                                                                                                                                           | [models.ListEntityUnmatchedCreditTransferSource](../models/listentityunmatchedcredittransfersource.md)                                             | :heavy_check_mark:                                                                                                                                 | Details about the sender of the credit transfer.                                                                                                   |                                                                                                                                                    |
| `remittanceInformation`                                                                                                                            | [models.ListEntityUnmatchedCreditTransferRemittanceInformation](../models/listentityunmatchedcredittransferremittanceinformation.md)               | :heavy_check_mark:                                                                                                                                 | Remittance information provided with the unmatched credit transfer.                                                                                |                                                                                                                                                    |
...
| `links`                                                                                                                                            | [models.ListEntityUnmatchedCreditTransferLinks](../models/listentityunmatchedcredittransferlinks.md)                                               | :heavy_check_mark:                                                                                                                                 | Links to related resources.                                                                                                                        |                                                                                                                                                    |