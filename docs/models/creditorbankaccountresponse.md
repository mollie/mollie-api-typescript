...
```typescript
import { CreditorBankAccountResponse } from "mollie-api-typescript/models";

let value: CreditorBankAccountResponse = {
...
| `format`                                                                       | [models.AccountNumberFormatResponse](../models/accountnumberformatresponse.md) | :heavy_check_mark:                                                             | The format of the account number.                                              | iban                                                                           |
