...
```typescript
import { PendingBalancePendingSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: PendingBalancePendingSubtotalTransactionType2 = "payment";
```
