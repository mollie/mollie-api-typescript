...
```typescript
import { ListSettlementChargebacksResponseBody } from "mollie-api-typescript/models/operations";

let value: ListSettlementChargebacksResponseBody = {
  count: 5,
  embedded: {
    chargebacks: [
      {
...
| `embedded`                                                                                                                                                                                                                                                                | [operations.ListSettlementChargebacksEmbedded](../../models/operations/listsettlementchargebacksembedded.md)                                                                                                                                                              | :heavy_check_mark:                                                                                                                                                                                                                                                        | N/A                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                           |
