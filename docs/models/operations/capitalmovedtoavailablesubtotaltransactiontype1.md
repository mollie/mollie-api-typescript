...
```typescript
import { CapitalMovedToAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: CapitalMovedToAvailableSubTotalTransactionType1 = "payment";
```
