...
```typescript
import { ListUnmatchedCreditTransfersResponseBody } from "mollie-api-typescript/models/operations";

let value: ListUnmatchedCreditTransfersResponseBody = {
  count: 5,
  embedded: {
...
| `embedded`                                                                                                                                                                                                                                                                | [operations.ListUnmatchedCreditTransfersEmbedded](../../models/operations/listunmatchedcredittransfersembedded.md)                                                                                                                                                        | :heavy_check_mark:                                                                                                                                                                                                                                                        | N/A                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                           |
