...
```typescript
import { TransfersMovedToAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: TransfersMovedToAvailableSubTotalTransactionType1 = "payment";
```
