...
```typescript
import { FeePrepaymentsMovedToAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsMovedToAvailableSubTotalMethod1 = "creditcard";
```
