...
```typescript
import { RefundsMovedToAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: RefundsMovedToAvailableSubtotalFeeType2 = "payment-fee";
```
