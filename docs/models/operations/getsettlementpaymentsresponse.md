...
```typescript
import { GetSettlementPaymentsResponse } from "mollie-api-typescript/models/operations";

let value: GetSettlementPaymentsResponse = {
  count: 5,
  embedded: {
    payments: [
      {
...
| `embedded`                                                                                                                                                                                                                                                                | [operations.GetSettlementPaymentsEmbedded](../../models/operations/getsettlementpaymentsembedded.md)                                                                                                                                                                      | :heavy_minus_sign:                                                                                                                                                                                                                                                        | N/A                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                           |
| `links`                                                                                                                                                                                                                                                                   | [operations.GetSettlementPaymentsLinks](../../models/operations/getsettlementpaymentslinks.md)                                                                                                                                                                            | :heavy_minus_sign:                                                                                                                                                                                                                                                        | Links to help navigate through the lists of items. Every URL object will contain an `href` and a `type` field.                                                                                                                                                            |                                                                                                                                                                                                                                                                           |