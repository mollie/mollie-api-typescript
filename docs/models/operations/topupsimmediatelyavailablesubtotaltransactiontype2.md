...
```typescript
import { TopupsImmediatelyAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: TopupsImmediatelyAvailableSubtotalTransactionType2 = "payment";
```
