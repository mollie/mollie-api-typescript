...
```typescript
import { ListSubscriptionPaymentsApplicationFeeAmount } from "mollie-api-typescript/models/operations";

let value: ListSubscriptionPaymentsApplicationFeeAmount = {
  currency: "EUR",
  value: "10.00",
};
```
