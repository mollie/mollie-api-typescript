...
```typescript
import { ListAllRefundsResponseBody } from "mollie-api-typescript/models/operations";

let value: ListAllRefundsResponseBody = {
  count: 5,
  embedded: {
    refunds: [
      {
...
| `embedded`                                                                                                                                                                                                                                                                | [operations.ListAllRefundsEmbedded](../../models/operations/listallrefundsembedded.md)                                                                                                                                                                                    | :heavy_check_mark:                                                                                                                                                                                                                                                        | N/A                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                           |
