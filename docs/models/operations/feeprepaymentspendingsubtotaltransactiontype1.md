...
```typescript
import { FeePrepaymentsPendingSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsPendingSubTotalTransactionType1 = "payment";
```
