...
```typescript
import { PendingBalanceOpenSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: PendingBalanceOpenSubTotalTransactionType1 = "payment";
```
