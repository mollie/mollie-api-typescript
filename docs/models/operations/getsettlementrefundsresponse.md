...
```typescript
import { GetSettlementRefundsResponse } from "mollie-api-typescript/models/operations";

let value: GetSettlementRefundsResponse = {
  count: 5,
  embedded: {
    refunds: [
      {
...
| `embedded`                                                                                                                                                                                                                                                                | [operations.GetSettlementRefundsEmbedded](../../models/operations/getsettlementrefundsembedded.md)                                                                                                                                                                        | :heavy_minus_sign:                                                                                                                                                                                                                                                        | N/A                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                           |
| `links`                                                                                                                                                                                                                                                                   | [operations.GetSettlementRefundsLinks](../../models/operations/getsettlementrefundslinks.md)                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                                                                                                        | Links to help navigate through the lists of items. Every URL object will contain an `href` and a `type` field.                                                                                                                                                            |                                                                                                                                                                                                                                                                           |