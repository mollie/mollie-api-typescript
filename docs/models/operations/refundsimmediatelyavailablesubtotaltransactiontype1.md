...
```typescript
import { RefundsImmediatelyAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: RefundsImmediatelyAvailableSubTotalTransactionType1 = "payment";
```
