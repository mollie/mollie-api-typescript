...
```typescript
import { TopupsMovedToAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: TopupsMovedToAvailableSubTotalFeeType1 = "payment-fee";
```
