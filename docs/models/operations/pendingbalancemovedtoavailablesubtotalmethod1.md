...
```typescript
import { PendingBalanceMovedToAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: PendingBalanceMovedToAvailableSubTotalMethod1 = "creditcard";
```
