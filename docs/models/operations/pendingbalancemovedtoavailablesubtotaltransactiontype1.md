...
```typescript
import { PendingBalanceMovedToAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: PendingBalanceMovedToAvailableSubTotalTransactionType1 = "payment";
```
