...
```typescript
import { CorrectionsMovedToAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: CorrectionsMovedToAvailableSubTotalFeeType1 = "payment-fee";
```
