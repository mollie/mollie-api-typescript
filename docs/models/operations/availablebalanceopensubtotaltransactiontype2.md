...
```typescript
import { AvailableBalanceOpenSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: AvailableBalanceOpenSubtotalTransactionType2 = "payment";
```
