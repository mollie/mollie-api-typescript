...
```typescript
import { PaymentsImmediatelyAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: PaymentsImmediatelyAvailableSubTotalTransactionType1 = "payment";
```
