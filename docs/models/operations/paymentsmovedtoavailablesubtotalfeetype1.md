...
```typescript
import { PaymentsMovedToAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: PaymentsMovedToAvailableSubTotalFeeType1 = "payment-fee";
```
