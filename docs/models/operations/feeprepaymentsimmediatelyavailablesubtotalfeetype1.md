...
```typescript
import { FeePrepaymentsImmediatelyAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsImmediatelyAvailableSubTotalFeeType1 = "payment-fee";
```
