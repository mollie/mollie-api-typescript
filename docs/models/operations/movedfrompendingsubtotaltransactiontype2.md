...
```typescript
import { MovedFromPendingSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: MovedFromPendingSubtotalTransactionType2 = "payment";
```
