...
```typescript
import { PendingBalanceMovedToAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: PendingBalanceMovedToAvailableSubtotalTransactionType2 = "payment";
```
