...
```typescript
import { ChargebacksMovedToAvailableSubtotalMethod2 } from "mollie-api-typescript/models/operations";

let value: ChargebacksMovedToAvailableSubtotalMethod2 = "creditcard";
```
