...
```typescript
import { ChargebacksMovedToAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: ChargebacksMovedToAvailableSubtotalFeeType2 = "payment-fee";
```
