...
```typescript
import { GetSettlementPaymentsEmbedded } from "mollie-api-typescript/models/operations";

let value: GetSettlementPaymentsEmbedded = {
  payments: [
    {
      resource: "payment",
      id: "tr_5B8cwPMGnU",
...
| ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `payments`                                                                                                       | [operations.GetSettlementPaymentsPaymentOutput](../../models/operations/getsettlementpaymentspaymentoutput.md)[] | :heavy_minus_sign:                                                                                               | An array of payment objects.                                                                                     |