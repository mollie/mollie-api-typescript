...
```typescript
import { TransfersMovedToAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: TransfersMovedToAvailableSubTotalFeeType1 = "payment-fee";
```
