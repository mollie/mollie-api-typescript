...
```typescript
import { CapitalImmediatelyAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: CapitalImmediatelyAvailableSubtotalFeeType2 = "payment-fee";
```
