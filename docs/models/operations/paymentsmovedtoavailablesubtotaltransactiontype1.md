...
```typescript
import { PaymentsMovedToAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: PaymentsMovedToAvailableSubTotalTransactionType1 = "payment";
```
