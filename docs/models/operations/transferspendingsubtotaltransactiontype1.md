...
```typescript
import { TransfersPendingSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: TransfersPendingSubTotalTransactionType1 = "payment";
```
