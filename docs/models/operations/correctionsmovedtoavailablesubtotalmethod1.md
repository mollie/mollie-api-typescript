...
```typescript
import { CorrectionsMovedToAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: CorrectionsMovedToAvailableSubTotalMethod1 = "creditcard";
```
