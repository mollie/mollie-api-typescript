...
```typescript
import { RefundsMovedToAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: RefundsMovedToAvailableSubtotalTransactionType2 = "payment";
```
