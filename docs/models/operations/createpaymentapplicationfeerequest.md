...
```typescript
import { CreatePaymentApplicationFeeRequest } from "mollie-api-typescript/models/operations";

let value: CreatePaymentApplicationFeeRequest = {
  amount: {
    currency: "EUR",
    value: "10.00",
  },
