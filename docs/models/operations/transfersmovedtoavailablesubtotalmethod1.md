...
```typescript
import { TransfersMovedToAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: TransfersMovedToAvailableSubTotalMethod1 = "creditcard";
```
