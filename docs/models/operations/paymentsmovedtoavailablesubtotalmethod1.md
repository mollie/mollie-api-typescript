...
```typescript
import { PaymentsMovedToAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: PaymentsMovedToAvailableSubTotalMethod1 = "creditcard";
```
