...
```typescript
import { CapitalImmediatelyAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: CapitalImmediatelyAvailableSubTotalMethod1 = "creditcard";
```
