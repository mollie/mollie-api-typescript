...
```typescript
import { PendingBalanceMovedToAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: PendingBalanceMovedToAvailableSubtotalFeeType2 = "payment-fee";
```
