...
```typescript
import { FeePrepaymentsImmediatelyAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsImmediatelyAvailableSubtotalTransactionType2 =
  "payment";
```
