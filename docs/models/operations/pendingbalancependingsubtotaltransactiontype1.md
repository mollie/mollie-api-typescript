...
```typescript
import { PendingBalancePendingSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: PendingBalancePendingSubTotalTransactionType1 = "payment";
```
