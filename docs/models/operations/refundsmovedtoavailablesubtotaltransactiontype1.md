...
```typescript
import { RefundsMovedToAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: RefundsMovedToAvailableSubTotalTransactionType1 = "payment";
```
