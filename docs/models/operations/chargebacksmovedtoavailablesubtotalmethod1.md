...
```typescript
import { ChargebacksMovedToAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: ChargebacksMovedToAvailableSubTotalMethod1 = "creditcard";
```
