...
```typescript
import { TransfersPendingSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: TransfersPendingSubtotalTransactionType2 = "payment";
```
