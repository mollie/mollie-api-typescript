...
```typescript
import { PendingBalanceCloseSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: PendingBalanceCloseSubTotalTransactionType1 = "payment";
```
