...
```typescript
import { AvailableBalanceImmediatelyAvailableSubtotalMethod2 } from "mollie-api-typescript/models/operations";

let value: AvailableBalanceImmediatelyAvailableSubtotalMethod2 = "creditcard";
```
