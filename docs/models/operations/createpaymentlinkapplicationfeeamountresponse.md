...
```typescript
import { CreatePaymentLinkApplicationFeeAmountResponse } from "mollie-api-typescript/models/operations";

let value: CreatePaymentLinkApplicationFeeAmountResponse = {
  currency: "EUR",
  value: "10.00",
};
```
