...
```typescript
import { CorrectionsMovedToAvailableSubtotalMethod2 } from "mollie-api-typescript/models/operations";

let value: CorrectionsMovedToAvailableSubtotalMethod2 = "creditcard";
```
