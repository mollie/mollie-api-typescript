...
```typescript
import { FeePrepaymentsMovedToAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsMovedToAvailableSubtotalTransactionType2 = "payment";
```
