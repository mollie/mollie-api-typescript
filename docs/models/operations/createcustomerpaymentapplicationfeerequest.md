...
```typescript
import { CreateCustomerPaymentApplicationFeeRequest } from "mollie-api-typescript/models/operations";

let value: CreateCustomerPaymentApplicationFeeRequest = {
  amount: {
    currency: "EUR",
    value: "10.00",
  },
