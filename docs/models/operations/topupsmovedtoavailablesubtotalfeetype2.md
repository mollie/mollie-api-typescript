...
```typescript
import { TopupsMovedToAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: TopupsMovedToAvailableSubtotalFeeType2 = "payment-fee";
```
