...
```typescript
import { TransfersMovedToAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: TransfersMovedToAvailableSubtotalFeeType2 = "payment-fee";
```
