...
```typescript
import { RefundsImmediatelyAvailableSubtotalMethod2 } from "mollie-api-typescript/models/operations";

let value: RefundsImmediatelyAvailableSubtotalMethod2 = "creditcard";
```
