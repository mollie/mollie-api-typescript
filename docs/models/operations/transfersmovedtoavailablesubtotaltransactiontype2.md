...
```typescript
import { TransfersMovedToAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: TransfersMovedToAvailableSubtotalTransactionType2 = "payment";
```
