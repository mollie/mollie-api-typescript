...
```typescript
import { ChargebacksPendingSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: ChargebacksPendingSubtotalTransactionType2 = "payment";
```
