...
```typescript
import { FeePrepaymentsImmediatelyAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsImmediatelyAvailableSubTotalTransactionType1 =
  "payment";
```
