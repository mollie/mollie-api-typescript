...
```typescript
import { AvailableBalanceImmediatelyAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: AvailableBalanceImmediatelyAvailableSubtotalTransactionType2 =
  "payment";
```
