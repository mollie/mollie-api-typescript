...
```typescript
import { PaymentsImmediatelyAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: PaymentsImmediatelyAvailableSubtotalFeeType2 = "payment-fee";
```
