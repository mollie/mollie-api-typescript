...
```typescript
import { PaymentsImmediatelyAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: PaymentsImmediatelyAvailableSubTotalFeeType1 = "payment-fee";
```
