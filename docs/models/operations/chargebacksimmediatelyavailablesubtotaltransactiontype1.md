...
```typescript
import { ChargebacksImmediatelyAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: ChargebacksImmediatelyAvailableSubTotalTransactionType1 = "payment";
```
