...
```typescript
import { PendingBalanceCloseSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: PendingBalanceCloseSubtotalTransactionType2 = "payment";
```
