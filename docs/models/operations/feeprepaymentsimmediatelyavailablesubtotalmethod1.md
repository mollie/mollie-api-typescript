...
```typescript
import { FeePrepaymentsImmediatelyAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsImmediatelyAvailableSubTotalMethod1 = "creditcard";
```
