...
```typescript
import { ListSettlementCapturesResponseBody } from "mollie-api-typescript/models/operations";

let value: ListSettlementCapturesResponseBody = {
  count: 5,
  embedded: {
    captures: [],
  },
...
| `embedded`                                                                                                                                                                                                                                                                | [operations.ListSettlementCapturesEmbedded](../../models/operations/listsettlementcapturesembedded.md)                                                                                                                                                                    | :heavy_check_mark:                                                                                                                                                                                                                                                        | N/A                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                           |
