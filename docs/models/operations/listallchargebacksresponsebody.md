...
```typescript
import { ListAllChargebacksResponseBody } from "mollie-api-typescript/models/operations";

let value: ListAllChargebacksResponseBody = {
  count: 5,
  embedded: {
    chargebacks: [],
  },
...
| `embedded`                                                                                                                                                                                                                                                                | [operations.ListAllChargebacksEmbedded](../../models/operations/listallchargebacksembedded.md)                                                                                                                                                                            | :heavy_check_mark:                                                                                                                                                                                                                                                        | N/A                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                           |
