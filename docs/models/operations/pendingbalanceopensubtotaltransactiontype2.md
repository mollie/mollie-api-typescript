...
```typescript
import { PendingBalanceOpenSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: PendingBalanceOpenSubtotalTransactionType2 = "payment";
```
