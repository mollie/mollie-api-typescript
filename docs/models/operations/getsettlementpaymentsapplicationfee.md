...
```typescript
import { GetSettlementPaymentsApplicationFee } from "mollie-api-typescript/models/operations";

let value: GetSettlementPaymentsApplicationFee = {
  amount: {
    currency: "EUR",
    value: "10.00",
  },
