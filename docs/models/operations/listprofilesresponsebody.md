...
```typescript
import { ListProfilesResponseBody } from "mollie-api-typescript/models/operations";

let value: ListProfilesResponseBody = {
  count: 5,
  embedded: {
    profiles: [],
  },
...
| `embedded`                                                                                                                                                                                                                                                                | [operations.ListProfilesEmbedded](../../models/operations/listprofilesembedded.md)                                                                                                                                                                                        | :heavy_check_mark:                                                                                                                                                                                                                                                        | N/A                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                           |
