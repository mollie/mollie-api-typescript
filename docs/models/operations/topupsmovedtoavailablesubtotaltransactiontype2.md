...
```typescript
import { TopupsMovedToAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: TopupsMovedToAvailableSubtotalTransactionType2 = "payment";
```
