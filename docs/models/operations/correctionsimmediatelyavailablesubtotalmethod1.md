...
```typescript
import { CorrectionsImmediatelyAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: CorrectionsImmediatelyAvailableSubTotalMethod1 = "creditcard";
```
