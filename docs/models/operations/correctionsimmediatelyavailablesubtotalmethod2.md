...
```typescript
import { CorrectionsImmediatelyAvailableSubtotalMethod2 } from "mollie-api-typescript/models/operations";

let value: CorrectionsImmediatelyAvailableSubtotalMethod2 = "creditcard";
```
