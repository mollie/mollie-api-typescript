...
```typescript
import { AvailableBalanceImmediatelyAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: AvailableBalanceImmediatelyAvailableSubTotalTransactionType1 =
  "payment";
```
