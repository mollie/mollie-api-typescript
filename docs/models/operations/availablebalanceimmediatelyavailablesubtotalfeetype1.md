...
```typescript
import { AvailableBalanceImmediatelyAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: AvailableBalanceImmediatelyAvailableSubTotalFeeType1 = "payment-fee";
```
