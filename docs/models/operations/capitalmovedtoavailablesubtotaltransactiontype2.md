...
```typescript
import { CapitalMovedToAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: CapitalMovedToAvailableSubtotalTransactionType2 = "payment";
```
