...
```typescript
import { CapitalImmediatelyAvailableSubtotalMethod2 } from "mollie-api-typescript/models/operations";

let value: CapitalImmediatelyAvailableSubtotalMethod2 = "creditcard";
```
