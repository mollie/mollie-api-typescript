...
```typescript
import { PaymentsMovedToAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: PaymentsMovedToAvailableSubtotalTransactionType2 = "payment";
```
