...
```typescript
import { TransfersImmediatelyAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: TransfersImmediatelyAvailableSubTotalMethod1 = "creditcard";
```
