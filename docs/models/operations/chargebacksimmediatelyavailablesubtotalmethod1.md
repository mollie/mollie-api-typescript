...
```typescript
import { ChargebacksImmediatelyAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: ChargebacksImmediatelyAvailableSubTotalMethod1 = "creditcard";
```
