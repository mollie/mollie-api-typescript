...
```typescript
import { AvailableBalanceImmediatelyAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: AvailableBalanceImmediatelyAvailableSubtotalFeeType2 = "payment-fee";
```
