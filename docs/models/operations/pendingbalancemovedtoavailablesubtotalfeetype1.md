...
```typescript
import { PendingBalanceMovedToAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: PendingBalanceMovedToAvailableSubTotalFeeType1 = "payment-fee";
```
