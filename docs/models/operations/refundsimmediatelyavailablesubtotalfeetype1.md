...
```typescript
import { RefundsImmediatelyAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: RefundsImmediatelyAvailableSubTotalFeeType1 = "payment-fee";
```
