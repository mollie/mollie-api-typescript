...
```typescript
import { RefundsImmediatelyAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: RefundsImmediatelyAvailableSubTotalMethod1 = "creditcard";
```
