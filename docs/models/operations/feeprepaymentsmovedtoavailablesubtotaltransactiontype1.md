...
```typescript
import { FeePrepaymentsMovedToAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsMovedToAvailableSubTotalTransactionType1 = "payment";
```
