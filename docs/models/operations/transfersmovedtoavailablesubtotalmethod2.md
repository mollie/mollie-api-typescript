...
```typescript
import { TransfersMovedToAvailableSubtotalMethod2 } from "mollie-api-typescript/models/operations";

let value: TransfersMovedToAvailableSubtotalMethod2 = "creditcard";
```
