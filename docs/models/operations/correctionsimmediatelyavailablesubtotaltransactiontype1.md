...
```typescript
import { CorrectionsImmediatelyAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: CorrectionsImmediatelyAvailableSubTotalTransactionType1 = "payment";
```
