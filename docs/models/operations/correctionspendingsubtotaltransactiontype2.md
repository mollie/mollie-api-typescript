...
```typescript
import { CorrectionsPendingSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: CorrectionsPendingSubtotalTransactionType2 = "payment";
```
