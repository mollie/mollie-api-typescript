...
```typescript
import { PaymentsImmediatelyAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: PaymentsImmediatelyAvailableSubTotalMethod1 = "creditcard";
```
