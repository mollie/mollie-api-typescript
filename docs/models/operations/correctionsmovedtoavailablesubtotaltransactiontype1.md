...
```typescript
import { CorrectionsMovedToAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: CorrectionsMovedToAvailableSubTotalTransactionType1 = "payment";
```
