...
```typescript
import { AvailableBalanceImmediatelyAvailableSubTotalMethod1 } from "mollie-api-typescript/models/operations";

let value: AvailableBalanceImmediatelyAvailableSubTotalMethod1 = "creditcard";
```
