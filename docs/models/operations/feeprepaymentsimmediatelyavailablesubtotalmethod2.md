...
```typescript
import { FeePrepaymentsImmediatelyAvailableSubtotalMethod2 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsImmediatelyAvailableSubtotalMethod2 = "creditcard";
```
