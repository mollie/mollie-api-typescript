...
```typescript
import { MovedFromPendingSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: MovedFromPendingSubTotalTransactionType1 = "payment";
```
