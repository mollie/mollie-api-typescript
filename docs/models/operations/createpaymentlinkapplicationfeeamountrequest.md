...
```typescript
import { CreatePaymentLinkApplicationFeeAmountRequest } from "mollie-api-typescript/models/operations";

let value: CreatePaymentLinkApplicationFeeAmountRequest = {
  currency: "EUR",
  value: "10.00",
};
```
