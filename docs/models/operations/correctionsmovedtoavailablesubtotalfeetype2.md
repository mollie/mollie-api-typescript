...
```typescript
import { CorrectionsMovedToAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: CorrectionsMovedToAvailableSubtotalFeeType2 = "payment-fee";
```
