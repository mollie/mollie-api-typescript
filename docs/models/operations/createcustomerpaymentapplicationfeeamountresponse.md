...
```typescript
import { CreateCustomerPaymentApplicationFeeAmountResponse } from "mollie-api-typescript/models/operations";

let value: CreateCustomerPaymentApplicationFeeAmountResponse = {
  currency: "EUR",
  value: "10.00",
};
```
