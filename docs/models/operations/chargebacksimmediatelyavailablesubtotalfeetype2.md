...
```typescript
import { ChargebacksImmediatelyAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: ChargebacksImmediatelyAvailableSubtotalFeeType2 = "payment-fee";
```
