...
```typescript
import { ChargebacksMovedToAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: ChargebacksMovedToAvailableSubTotalFeeType1 = "payment-fee";
```
