...
```typescript
import { FeePrepaymentsPendingSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsPendingSubtotalTransactionType2 = "payment";
```
