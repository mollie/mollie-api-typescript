...
```typescript
import { FeePrepaymentsImmediatelyAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsImmediatelyAvailableSubtotalFeeType2 = "payment-fee";
```
