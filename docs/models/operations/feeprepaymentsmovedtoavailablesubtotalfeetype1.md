...
```typescript
import { FeePrepaymentsMovedToAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsMovedToAvailableSubTotalFeeType1 = "payment-fee";
```
