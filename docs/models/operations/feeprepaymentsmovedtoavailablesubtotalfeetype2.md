...
```typescript
import { FeePrepaymentsMovedToAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: FeePrepaymentsMovedToAvailableSubtotalFeeType2 = "payment-fee";
```
