...
```typescript
import { CapitalMovedToAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: CapitalMovedToAvailableSubTotalFeeType1 = "payment-fee";
```
