...
```typescript
import { GetSettlementPeriods } from "mollie-api-typescript/models/operations";

let value: GetSettlementPeriods = {
...
| ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| `lessThanYearGreaterThan`                                                                                          | [operations.GetSettlementLessThanYearGreaterThan](../../models/operations/getsettlementlessthanyeargreaterthan.md) | :heavy_minus_sign:                                                                                                 | N/A                                                                                                                |