...
```typescript
import { AvailableBalanceCloseSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: AvailableBalanceCloseSubtotalTransactionType2 = "payment";
```
