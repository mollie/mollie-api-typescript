...
```typescript
import { PendingBalanceMovedToAvailableSubtotalMethod2 } from "mollie-api-typescript/models/operations";

let value: PendingBalanceMovedToAvailableSubtotalMethod2 = "creditcard";
```
