...
```typescript
import { TopupsImmediatelyAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: TopupsImmediatelyAvailableSubtotalFeeType2 = "payment-fee";
```
