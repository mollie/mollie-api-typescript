...
```typescript
import { CorrectionsMovedToAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: CorrectionsMovedToAvailableSubtotalTransactionType2 = "payment";
```
