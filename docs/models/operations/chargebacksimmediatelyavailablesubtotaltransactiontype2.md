...
```typescript
import { ChargebacksImmediatelyAvailableSubtotalTransactionType2 } from "mollie-api-typescript/models/operations";

let value: ChargebacksImmediatelyAvailableSubtotalTransactionType2 = "payment";
```
