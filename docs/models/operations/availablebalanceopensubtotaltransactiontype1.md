...
```typescript
import { AvailableBalanceOpenSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: AvailableBalanceOpenSubTotalTransactionType1 = "payment";
```
