...
```typescript
import { TopupsImmediatelyAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: TopupsImmediatelyAvailableSubTotalTransactionType1 = "payment";
```
