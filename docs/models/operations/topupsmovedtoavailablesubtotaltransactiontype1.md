...
```typescript
import { TopupsMovedToAvailableSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: TopupsMovedToAvailableSubTotalTransactionType1 = "payment";
```
