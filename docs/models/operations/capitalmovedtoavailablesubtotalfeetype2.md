...
```typescript
import { CapitalMovedToAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: CapitalMovedToAvailableSubtotalFeeType2 = "payment-fee";
```
