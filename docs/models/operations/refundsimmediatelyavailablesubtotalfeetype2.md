...
```typescript
import { RefundsImmediatelyAvailableSubtotalFeeType2 } from "mollie-api-typescript/models/operations";

let value: RefundsImmediatelyAvailableSubtotalFeeType2 = "payment-fee";
```
