...
```typescript
import { CorrectionsPendingSubTotalTransactionType1 } from "mollie-api-typescript/models/operations";

let value: CorrectionsPendingSubTotalTransactionType1 = "payment";
```
