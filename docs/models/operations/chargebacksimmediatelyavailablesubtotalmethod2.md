...
```typescript
import { ChargebacksImmediatelyAvailableSubtotalMethod2 } from "mollie-api-typescript/models/operations";

let value: ChargebacksImmediatelyAvailableSubtotalMethod2 = "creditcard";
```
