...
```typescript
import { TopupsImmediatelyAvailableSubTotalFeeType1 } from "mollie-api-typescript/models/operations";

let value: TopupsImmediatelyAvailableSubTotalFeeType1 = "payment-fee";
```
