...
```typescript
import { ListEntityPermission } from "mollie-api-typescript/models";

let value: ListEntityPermission = {
  resource: "permission",
  id: "payments.read",
...
| `links`                                                                                                             | [models.ListEntityPermissionLinks](../models/listentitypermissionlinks.md)                                          | :heavy_check_mark:                                                                                                  | An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.                   |                                                                                                                     |