...
```typescript
import { ListSettlementPaymentResponseLinks } from "mollie-api-typescript/models";

let value: ListSettlementPaymentResponseLinks = {
  self: {
    href: "https://...",
...
| `changePaymentState`                                                                       | [models.UrlNullable](../models/urlnullable.md)                                             | :heavy_minus_sign:                                                                         | In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field. |
