...
/** @internal */
export const SubTotals2$inboundSchema: z.ZodType<
  SubTotals2,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function subTotals2FromJSON(
  jsonString: string,
): SafeParseResult<SubTotals2, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => SubTotals2$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'SubTotals2' from JSON`,
  );
}
