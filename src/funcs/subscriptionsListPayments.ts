...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSubscriptionPaymentsRequest$outboundSchema.parse(value),
  ...
  const path = options?.[URL_OVERRIDE]
    ? ""
    : pathToFunc(
      "/v2/customers/{customerId}/subscriptions/{subscriptionId}/payments",
    )(pathParams);
