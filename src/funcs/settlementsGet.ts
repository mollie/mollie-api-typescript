...
export function settlementsGet(
  ...
  Result<
    operations.GetSettlementResponse,
    | errors.GetSettlementHalJSONError
    | ClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSettlementRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSettlementResponse$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(404, errors.GetSettlementHalJSONError$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
