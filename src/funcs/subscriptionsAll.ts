 ...
 */
export function subscriptionsAll(
  client: ClientCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAllSubscriptionsRequest$outboundSchema.optional().parse(
        value,
      ),
