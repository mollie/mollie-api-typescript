 ...
 */
export function draftTransfersList(
  client: ClientCore,
  ...
  PageIterator<
    Result<
      operations.ListDraftTransfersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListDraftTransfersRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = options?.[URL_OVERRIDE]
    ? ""
    : pathToFunc("/v2/business-accounts/draft-transfers")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListDraftTransfersResponse$inboundSchema, {
