 ...
 */
export function methodsEnableIssuer(
  client: ClientCore,
  request: operations.EnableMethodIssuerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.EnableMethodIssuerResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.EnableMethodIssuerRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc(
    "/v2/profiles/{profileId}/methods/{methodId}/issuers/{issuerId}",
  )(pathParams);
