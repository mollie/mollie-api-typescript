 ...
 */
export function chargebacksList(
  client: ClientCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListChargebacksRequest$outboundSchema.parse(value),
  ...
  const path = options?.[URL_OVERRIDE]
    ? ""
    : pathToFunc("/v2/payments/{paymentId}/chargebacks")(pathParams);
