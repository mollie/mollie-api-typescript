...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateProfileRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr([403, 404, 410, 422, 429], errors.ErrorResponse$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
