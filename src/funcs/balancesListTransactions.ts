...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListBalanceTransactionsRequest$outboundSchema.parse(value),
  ...
  const path = options?.[URL_OVERRIDE]
    ? ""
    : pathToFunc("/v2/balances/{balanceId}/transactions")(pathParams);
