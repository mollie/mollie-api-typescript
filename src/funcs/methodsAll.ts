...
export function methodsAll(
  ...
  Result<
    operations.ListAllMethodsResponse,
    | errors.ListAllMethodsHalJSONError
    | ClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAllMethodsRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAllMethodsResponse$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(400, errors.ListAllMethodsHalJSONError$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
