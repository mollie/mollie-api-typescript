...
export function mandatesGet(
  ...
  Result<
    operations.GetMandateResponse,
    | errors.GetMandateHalJSONError
    | ClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetMandateRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    mandateId: encodeSimple("mandateId", payload.mandateId, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/customers/{customerId}/mandates/{mandateId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetMandateResponse$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(404, errors.GetMandateHalJSONError$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
