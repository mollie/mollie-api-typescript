...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateMandateRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/customers/{customerId}/mandates")(pathParams);
