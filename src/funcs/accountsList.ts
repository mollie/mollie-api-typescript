...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListBusinessAccountTransactionsRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ListBusinessAccountTransactionsResponse$inboundSchema,
      { ctype: "application/hal+json", key: "Result" },
    ),
