...
export function webhooksCreate(
  ...
  Result<
    ...
    | errors.CreateWebhookHalJSONError
    | ClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateWebhookRequest$outboundSchema.optional().parse(value),
  ...
  >(
    ...
    M.jsonErr(422, errors.CreateWebhookHalJSONError$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
