...
export function settlementsGetOpen(
  ...
  Result<
    operations.GetOpenSettlementResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetOpenSettlementRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/settlements/open")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetOpenSettlementResponse$inboundSchema, {
