...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListCustomerPaymentsRequest$outboundSchema.parse(value),
  ...
  const path = options?.[URL_OVERRIDE]
    ? ""
    : pathToFunc("/v2/customers/{customerId}/payments")(pathParams);
