...
export function terminalsGet(
  ...
  Result<
    operations.GetTerminalResponse,
    | errors.GetTerminalHalJSONError
    | ClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetTerminalRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetTerminalResponse$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(404, errors.GetTerminalHalJSONError$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
