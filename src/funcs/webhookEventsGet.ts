...
export function webhookEventsGet(
  ...
  Result<
    operations.GetWebhookEventResponse,
    | errors.GetWebhookEventHalJSONError
    | ClientError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetWebhookEventRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetWebhookEventResponse$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(404, errors.GetWebhookEventHalJSONError$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
