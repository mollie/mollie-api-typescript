...
export function organizationsGetPartner(
  ...
  Result<
    operations.GetPartnerStatusResponse,
    | ClientError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetPartnerStatusRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/v2/organizations/me/partner")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPartnerStatusResponse$inboundSchema, {
