 ...
 * @generated-id: a1fd601e4fc8
 */

import { walletsRequestApplePaySession } from "../../funcs/walletsRequestApplePaySession.js";
import * as operations from "../../models/operations/index.js";
import { formatResult, ToolDefinition } from "../tools.js";

const args = {
  request: operations.RequestApplePayPaymentSessionRequest$inboundSchema
    .optional(),
};

export const tool$walletsRequestApplePaySession: ToolDefinition<typeof args> = {
  name: "wallets-request-apple-pay-session",
  description: `Request Apple Pay payment session
...
[Apple Pay JS API](https://developer.apple.com/documentation/apple_pay_on_the_web/apple_pay_js_api) documentation.`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await walletsRequestApplePaySession(
      client,
      args.request,
